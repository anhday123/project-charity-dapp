    ...
    return (
        ...
        >
            ...
            {showForm1 && (
              ...
              <div className="form__div">
                  <input type="number" className="form__input" placeholder="Số chứng Minh Nhân Dân" onChange={e => setCMND(e.target.value)}/>
              </div>
              ...
              <div className="container">
                ...
                >
                    {
                        !fileImgR && (
                            <>
                                <p style={{color:"#000"}}>Đính kèm ảnh chương mình nhân dân</p>
                ...
                {
                  fileImgR && (
                    <button onClick={() => setFileImgR(null)}>Tải lại</button>
                  )
                }  
            </div>
        </div>
        <div className="container">
                ...
                {
                  fileImg1R && (
                    <button  onClick={() => setFileImg1R(null)}>Tải lại</button>
                  )
                }  
            </div>
        </div>
            ...
            {listReceiver.filter(item => item.projectID === id ).map(result =>result.locationR) != "" ? (
              ...
              <h1>Danh sách đăng kí nhận hỗ trợ</h1>
                  ...
                  {showForm2 && (
                    <form action="" className="form" style={{height: "1000px", marginTop: "16px"}}>  
                      {listReceiver.filter(item => item.receiverAddress === querystring).map((item, index) => (
                        <>
                          <h2>{item.nameR}</h2>
                          <h3>{item.CMND}</h3>
                          <h3>{item.receiverAddress}</h3>
                          <h3>{item.locationR}</h3>
                          <h3>{item.descriptionR}</h3>
                          <h3>{item.take}</h3>
                          <img style={{height: "200px"}} src={item.imageUrlR} alt=""  /><br></br>
                          <img style={{height: "200px"}} src={item.imageUrl1R} alt=""  />
